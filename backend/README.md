...
## Project Structure
    ...
    ├── test_app_scheduling_38120  # Django project configurations
...
1. Clone this repo and `cd test_app_scheduling_38120`
...
2. Clone this repo and `cd test_app_scheduling_38120`
